...
const Dashboard = ({ data }) => {
    ...
    const getDoctors = async () => {
        await axios
            .get("https://mydoctor-burhanpur.herokuapp.com/doctors")
    ...
    const submitHandle = async (e) => {
        ...
        const response = await axios
            .post("https://mydoctor-burhanpur.herokuapp.com/doctors/add", body)
            .catch((err) => console.log(err.message));
        if (response.data) {
            alert("Doctor Added!!");
            setFormData(false);
    ...
    if (activeForm) {
        ...
        component = (
            <div className="profile">
                ...
                <br />
                <Button variant="outlined" > <Link to="/register-new-Account" >Create new account</Link> </Button>
            </div>
        );
    } else {
        component = (
